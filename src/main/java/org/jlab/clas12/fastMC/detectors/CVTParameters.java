...
public class CVTParameters {
    ...
    private Map initMap(){
        ...
        paramMap.put(1, new HashMap<String, Double>(){{
            put("numRegions", 10.0); put("zDistance", 11.4390); put("yDistance", 6.5588);
        }});
        paramMap.put(2, new HashMap<String, Double>(){{
            put("numRegions", 14.0); put("zDistance", 15.3821); put("yDistance", 9.3198);
        }});
        paramMap.put(3, new HashMap<String, Double>(){{
            put("numRegions", 18.0); put("zDistance", 19.2967); put("yDistance", 12.0608);
        }});
        paramMap.put(4, new HashMap<String, Double>(){{
            put("numRegions", 24.0); put("zDistance", 25.1414); put("yDistance", 16.1533);
        }});
