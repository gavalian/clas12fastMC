...
public class DC2Detector extends Detector {
    ...
    public DC2Detector() {
        ...
        this.setDistanceToTarget(params.getDist2Targ(2));
        this.thetaMin = params.getTHMin(2);
        this.wirePlaneDistance = params.getWPD(2);
        this.setTilt(25.0);
        init();
    }
